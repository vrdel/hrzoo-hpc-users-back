...
class User(Base):
    ...
    is_activated_project: Mapped[bool] = mapped_column(MutableJson)
    is_deactivated_project: Mapped[bool] = mapped_column(MutableJson)
    ...
    mail_project_is_activated: Mapped[List[dict]] = mapped_column(MutableJson)
    mail_project_is_deactivated: Mapped[List[dict]] = mapped_column(MutableJson)
